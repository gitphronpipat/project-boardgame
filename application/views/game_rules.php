...
$game_rules_registry = [
    ...
    'uno' => [
        ...
        'icon'        => '🃏',
        'color'       => '#dc2626',
        'category'    => 'การ์ดเกมปาร์ตี้ระดับสากล',
        'players'     => '2 - 12 คน',
        'time'        => '5 - 20 นาที',
        'objective'   => 'ผู้เล่นที่ทิ้งการ์ดใบสุดท้ายในมือได้หมดก่อนจะเป็นผู้ชนะในรอบนั้น',
        'rules'       => [
            'การเตรียมเกม: แจกการ์ดให้ผู้เล่นคนละ 7 ใบ กองที่เหลือเป็นกองจั่ว (Draw Pile) และเปิดการ์ดใบแรกวางเป็นกองทิ้ง (Discard Pile)',
            'เริ่มเล่นตามเข็มนาฬิกา: ในแต่ละเทิร์นต้องทิ้งการ์ด 1 ใบที่มี สี หรือ หมายเลข/สัญลักษณ์ ตรงกับการ์ดใบล่าสุดบนกองทิ้ง',
            'หากไม่มีการ์ดที่ลงได้ ต้องจั่วการ์ด 1 ใบจากกองจั่ว ถ้าใบที่จั่วมาเล่นได้ สามารถทิ้งได้ทันที ถ้าเล่นไม่ได้จะจบเทิร์น',
            'การ์ดพิเศษ (Action Cards):',
            '• Skip (ข้าม): ผู้เล่นคนถัดไปเสียเทิร์น',
            '• Reverse (กลับทิศ): เปลี่ยนทิศทางการเล่น (หากเล่น 2 คนจะทำหน้าที่เหมือน Skip)',
            '• Draw Two (+2): ผู้เล่นคนถัดไปต้องจั่ว 2 ใบ และเสียเทิร์น',
            '• Wild (เปลี่ยนสี): ทิ้งได้ทุกเมื่อ และเลือกสีใหม่ที่ต้องการให้เล่นต่อ',
            '• Wild Draw Four (+4): เลือกสีใหม่ และผู้เล่นคนถัดไปต้องจั่ว 4 ใบพร้อมเสียเทิร์น',
            'กฎสำคัญ "UNO!": เมื่อคุณเหลือการ์ดในมือเพียง 1 ใบ ต้องกดพูด "UNO!" ทันที หากลืมและผู้เล่นอื่นจับได้ก่อนเทิร์นถัดไป จะถูกลงโทษจั่ว 2 ใบ',
        ],
        'win_conditions'  => 'ทิ้งการ์ดบนมือจนหมดเป็นคนแรกในรอบนั้น และได้คะแนนสะสมจากการ์ดที่เหลือบนมือของผู้เล่นคนอื่น',
        'draw_conditions' => 'ไม่มีผลเสมอ (ผู้เล่นแข่งกันจนกว่าจะมีคนทิ้งการ์ดหมด)',
        'tips'            => 'การนับคะแนน: การ์ดตัวเลข (0-9) ตามแต้ม, การ์ดคำสั่ง (Skip, Reverse, +2) ใบละ 20 แต้ม, การ์ด Wild และ Wild +4 ใบละ 50 แต้ม',
    ],
    ...
    // -------------------------------------------------------------
    // 8. Minesweeper (เกมกู้ระเบิด)
    // -------------------------------------------------------------
    'minesweeper' => [
        'name'        => 'Minesweeper (เกมกู้ระเบิด)',
        'icon'        => '💣',
        'color'       => '#059669',
        'category'    => 'เกมพัซเซิลประลองปัญญา',
        'players'     => '1 - 4 คน',
        'time'        => '2 - 10 นาที',
        'objective'   => 'เปิดช่องปลอดภัยทั้งหมดบนกระดานและหลีกเลี่ยงทุ่นระเบิดที่ซ่อนอยู่',
        'rules'       => [
            'คลิกซ้ายเพื่อเปิดช่อง: ตัวเลขจะบอกจำนวนระเบิดใน 8 ช่องรอบข้าง (ถ้าเป็น 0 จะเปิดขยายพื้นที่อัตโนมัติ)',
            'คลิกขวาเพื่อปักธง 🚩: ใช้ระบุตำแหน่งที่สงสัยว่ามีระเบิดซ่อนอยู่',
            'คลิกแรกของการันตีว่าปลอดภัยเสมอ (First-click Safe)',
            'โหมดการเล่น 3 สไตล์:',
            '• 🌟 Versus (ชิงแต้ม): สลับเทิร์นเปิด เปิดช่องได้แต้ม ปักธงระเบิดถูกได้แต้มโบนัส ใครเหยียบระเบิดถูกหักแต้ม/Knockout',
            '• 🤝 Co-op (ช่วยกันกู้): ช่วยกันเปิดกระดาน มีพลังชีวิตทีม (3 HP) ช่วยกันจนจบกระดาน',
            '• 🚩 Flag Hunter (ล่าระเบิด): ใครหาทุ่นระเบิดเจอมากที่สุดเป็นผู้ชนะ',
        ],
        'win_conditions'  => 'เปิดช่องปลอดภัยครบทั้งกระดาน หรือผู้เล่นที่ได้คะแนนสูงสุดเมื่อจบเกม',
        'draw_conditions' => 'คะแนนเท่ากันเมื่อจบกระดาน',
        'tips'            => 'สังเกตตัวเลขมุมกระดาน เช่น เลข 1 ที่ติดกับช่องว่างเพียงช่องเดียว แปลว่าช่องนั้นคือระเบิดแน่นอน!',
    ],
];
